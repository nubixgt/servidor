...
--
-- Host: db.vider.maga.aws    Database: RegistroClimatologico
-- ------------------------------------------------------
...
CREATE TABLE `alertas` (
  ...
  CONSTRAINT `alertas_ibfk_1` FOREIGN KEY (`id_usuario_creador`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2026-06-09 16:25:32
