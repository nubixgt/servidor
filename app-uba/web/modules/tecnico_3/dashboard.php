<?php
// web/modules/tecnico_3/dashboard.php
require_once '../../config/database.php';
require_once '../../config/workflow.php';
require_once '../../includes/verificar_sesion.php';

verificarRol('tecnico_3');

try {
    $database = new Database();
    $db = $database->getConnection();

    // Obtener denuncias para emitir dictamen
    $etapas = WorkflowDenuncias::$etapasPorRol['tecnico_3'];
    ...
    // 4. Sin revisar (sin seguimiento en esta etapa)
...
<head>
    ...
    <title>Emitir Dictamen - Técnico 3 - AppUBA</title>
...
<body>
    <?php include '../../includes/navbar_tecnico3.php'; ?>

    <div class="dashboard-container">
        <!-- Header -->
        <div class="welcome-section">
            <h1><i class="fas fa-file-signature"></i> Mi Área: Emitir Dictamen</h1>
            <p class="subtitle">Emisión de dictámenes técnicos sobre denuncias</p>
        </div>
                    ...
                    <?php foreach ($denuncias as $denuncia): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/app-uba/web/modules/admin/emitir_dictamen/procesar.php?id=<?php echo $denuncia['id_denuncia']; ?>"
    ...
    <!-- JS personalizado -->
    <script src="../../js/dashboard_tecnico3.js"></script>
    ...
    <script>
        ...
        function verDetalleDenuncia(id) {
            Swal.fire({
                ...
                window.location.href = '/app-uba/web/modules/admin/emitir_dictamen/detalle_denuncia.php?id=' + id;
            });
        }
    </script>
