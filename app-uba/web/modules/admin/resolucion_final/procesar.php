<?php
// web/modules/admin/resolucion_final/procesar.php
require_once '../../../config/database.php';
require_once '../../../config/workflow.php';
require_once '../../../includes/verificar_sesion.php';

verificarRol(['admin', 'tecnico_5']); // Permitir admin y tecnico_5
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-section">
            <h1><i class="fas fa-gavel"></i> Procesar Denuncia #<?php echo $denuncia['id_denuncia']; ?></h1>
            <p>Resolución Final - Decisión final sobre la denuncia</p>
        </div>
                                    ...
                                    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(150px, 1fr)); gap: 10px; margin-top: 10px;">
                                        <?php foreach ($item['archivos'] as $archivo): ?>
                                            <?php if ($archivo['tipo_archivo'] == 'imagen'): ?>
                                                <!-- Imagen con preview -->
                                                <a href="<?php echo obtenerRutaArchivo($archivo['ruta_archivo']); ?>" 
                                                   target="_blank" 
                                                   style="display: block; border: 2px solid #e2e8f0; border-radius: 8px; overflow: hidden; transition: all 0.3s ease;">
                                                    ...
                                                    <div style="padding: 8px; background: #f8fafc; font-size: 0.75rem; color: #64748b; text-align: center;">
                                                        <i class="fas fa-image"></i> <?php echo htmlspecialchars(substr($archivo['nombre_archivo'], 0, 20)); ?>
                                                    </div>
                                                </a>
                                            <?php else: ?>
                                                ...
                                                <a href="<?php echo obtenerRutaArchivo($archivo['ruta_archivo']); ?>" 
                                                   ...
                                                   style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 15px; border: 2px solid #e2e8f0; border-radius: 8px; text-decoration: none; transition: all 0.3s ease; background: #f8fafc;">
                                                    ...
                                                    ?>
                                                    <i class="fas <?php echo $icono; ?>" style="color: <?php echo $colorIcono; ?>; font-size: 32px; margin-bottom: 8px;"></i>
                                                    <span style="font-size: 0.75rem; color: #475569; text-align: center; word-break: break-word;">
        ...
        <form id="formProcesar" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-buttons">
                ...
                <button type="submit" class="btn btn-resolver" data-accion="resuelto">
