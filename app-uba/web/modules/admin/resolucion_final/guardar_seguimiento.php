<?php
// web/modules/admin/resolucion_final/guardar_seguimiento.php
...
// IMPORTANTE: En Resolución Final aceptamos "resuelto" en lugar de "siguiente_paso"
if (!in_array($accion, ['resuelto', 'rechazado'])) {
...
try {
    ...
    // En Resolución Final siempre termina en 'finalizada'
    ...
    $stmtSeguimiento->execute([
        $id_denuncia,
        'resolucion_final', // Etapa donde se procesó
        $accion,
        $comentario,
        $etapaSiguiente,
        $_SESSION['usuario_id']
    ...
    echo json_encode([
        'success' => true,
        'message' => $accion == 'resuelto' ? 'Denuncia resuelta correctamente' : 'Denuncia rechazada correctamente'
    ]);
    exit;
