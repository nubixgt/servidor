<?php
// web/modules/admin/resolucion_final/index.php
...
<head>
    ...
    <title>Resolución Final - AppUBA</title>
...
<body>
    ...
    <div class="dashboard-container">
        <div class="welcome-section">
            <h1><i class="fas fa-check-double"></i> Resolución Final</h1>
            <p>Resolución final de denuncias de maltrato animal</p>
        </div>
