<?php
// web/modules/admin/area_legal/detalle_denuncia.php
...
$navbarFile = '../../../includes/navbar_admin.php';
$urlRetorno = 'index.php';

if ($rol === 'tecnico_1') {
    $navbarFile = '../../../includes/navbar_tecnico1.php';
    $urlRetorno = '../../tecnico_1/dashboard.php';
} elseif ($rol === 'tecnico_2') {
    $navbarFile = '../../../includes/navbar_tecnico2.php';
    $urlRetorno = '../../tecnico_2/dashboard.php';
} elseif ($rol === 'tecnico_3') {
    $navbarFile = '../../../includes/navbar_tecnico3.php';
    $urlRetorno = '../../tecnico_3/dashboard.php';
} elseif ($rol === 'tecnico_4') {
    $navbarFile = '../../../includes/navbar_tecnico4.php';
    $urlRetorno = '../../tecnico_4/dashboard.php';
} elseif ($rol === 'tecnico_5') {
    $navbarFile = '../../../includes/navbar_tecnico5.php';
    $urlRetorno = '../../tecnico_5/dashboard.php';
}
?>
<!DOCTYPE html>
<html lang="es">
            ...
            <div class="seccion-detalle">
                ...
                <div class="galeria-fotos">
                    <?php foreach ($evidencias as $evidencia): ?>
                        ...
                        <?php else: ?>
                            <!-- Evidencia tipo archivo (se muestra como card en la galería) -->
