<?php
// web/modules/admin/area_legal/procesar.php
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-section">
            <h1><i class="fas fa-clipboard-check"></i> Procesar Denuncia #<?php echo $denuncia['id_denuncia']; ?></h1>
            <p>Área Legal - Revisión de denuncia</p>
        </div>
                ...
                <div class="historial-timeline">
                    <?php foreach ($historial as $item): ?>
                        <div class="historial-item <?php echo $item['accion']; ?>">
                            ...
                            <?php if ($item['total_archivos'] > 0): ?>
                                <div class="historial-archivos">
                                    <span class="archivo-badge">
                                        <i class="fas fa-paperclip"></i> <?php echo $item['total_archivos']; ?> archivo(s)
                                        adjunto(s)
                                    </span>
                                </div>
                            <?php endif; ?>
