<?php
// web/modules/admin/opinion_legal/procesar.php
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-section">
            <h1><i class="fas fa-balance-scale"></i> Procesar Denuncia #<?php echo $denuncia['id_denuncia']; ?></h1>
            <p>Opinión Legal - Revisión legal especializada</p>
        </div>
