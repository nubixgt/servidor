<?php
// web/modules/admin/emitir_dictamen/index.php
...
<head>
    ...
    <title>Emitir Dictamen - AppUBA</title>
...
<body>
    ...
    <div class="dashboard-container">
        <div class="welcome-section">
            <h1><i class="fas fa-file-signature"></i> Emitir Dictamen</h1>
            <p>Emisión de dictamen técnico sobre denuncias de maltrato animal</p>
        </div>
