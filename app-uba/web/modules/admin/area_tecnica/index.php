<?php
// web/modules/admin/area_tecnica/index.php
require_once '../../../config/database.php';
require_once '../../../config/workflow.php';
require_once '../../../includes/verificar_sesion.php';

verificarRol(['admin', 'tecnico_2']); // Permitir admin y tecnico_2
...
<head>
    ...
    <title>Área Técnica - AppUBA</title>
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-section">
            <h1><i class="fas fa-tools"></i> Área Técnica</h1>
