<?php
// web/modules/admin/area_tecnica/procesar.php
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-section">
            <h1><i class="fas fa-tools"></i> Procesar Denuncia #<?php echo $denuncia['id_denuncia']; ?></h1>
            <p>Área Técnica - Evaluación técnica de denuncia</p>
        </div>
