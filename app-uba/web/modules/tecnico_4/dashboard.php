<?php
// web/modules/tecnico_4/dashboard.php
require_once '../../config/database.php';
require_once '../../config/workflow.php';
require_once '../../includes/verificar_sesion.php';

verificarRol('tecnico_4');
...
<head>
    ...
    <title>Opinión Legal - Técnico 4 - AppUBA</title>
...
<body>
    <?php include '../../includes/navbar_tecnico4.php'; ?>

    <div class="dashboard-container">
        <!-- Header -->
        <div class="welcome-section">
            <h1><i class="fas fa-gavel"></i> Mi Área: Opinión Legal</h1>
            <p class="subtitle">Opiniones legales especializadas sobre denuncias</p>
        </div>
                    ...
                    <?php foreach ($denuncias as $denuncia): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/app-uba/web/modules/admin/opinion_legal/procesar.php?id=<?php echo $denuncia['id_denuncia']; ?>"
    ...
    <!-- JS personalizado -->
    <script src="../../js/dashboard_tecnico4.js"></script>
    ...
    <script>
        ...
        function verDetalleDenuncia(id) {
            Swal.fire({
                ...
                window.location.href = '/app-uba/web/modules/admin/opinion_legal/detalle_denuncia.php?id=' + id;
            });
        }
    </script>
