<?php
// web/modules/tecnico_2/dashboard.php
require_once '../../config/database.php';
require_once '../../config/workflow.php';
require_once '../../includes/verificar_sesion.php';

verificarRol('tecnico_2');

try {
    $database = new Database();
    $db = $database->getConnection();

    // Obtener denuncias para área técnica
    $etapas = WorkflowDenuncias::$etapasPorRol['tecnico_2'];
...
<head>
    ...
    <title>Área Técnica - Técnico 2 - AppUBA</title>
...
<body>
    <?php include '../../includes/navbar_tecnico2.php'; ?>

    <div class="dashboard-container">
        <div class="welcome-section">
            <h1><i class="fas fa-tools"></i> Mi Área: Área Técnica</h1>
            <p>Evaluación técnica de denuncias de maltrato animal</p>
        </div>
                    ...
                    <?php foreach ($denuncias as $denuncia): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/app-uba/web/modules/admin/area_tecnica/procesar.php?id=<?php echo $denuncia['id_denuncia']; ?>"
    ...
    <!-- JS personalizado -->
    <script src="../../js/dashboard_tecnico2.js"></script>
    ...
    <script>
        ...
        function verDetalleDenuncia(id) {
            Swal.fire({
                ...
                window.location.href = '/app-uba/web/modules/admin/area_tecnica/detalle_denuncia.php?id=' + id;
            });
        }
    </script>
