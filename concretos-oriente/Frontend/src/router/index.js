...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'maquinaria-especial', name: 'MaquinariaEspecial', component: () => import('../views/admin/MaquinariaEspecial.vue'), meta: { requiresRole: 'admin' } },
            { path: 'combustible', name: 'Combustible', component: () => import('../views/admin/Combustible.vue'), meta: { requiresRole: 'admin' } },
            { path: 'mecanica', name: 'Mecanica', component: () => import('../views/admin/Mecanica.vue'), meta: { requiresRole: 'admin' } },
