...
const submitMachine = async () => {
  ...
  if (formMachine.value.clasificacion_tipo === 'Liviana' && !formMachine.value.frecuencia_servicio_horas) {
    Swal.fire({
      background: '#0f172a',
      color: '#fff',
      icon: 'warning',
      title: 'Frecuencia de Servicio requerida',
      text: 'Para maquinaria liviana debes indicar la frecuencia de servicio en horas.'
    });
    return;
  }
