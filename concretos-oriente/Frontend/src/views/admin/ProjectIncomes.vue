          ...
          <div class="bg-white/5 p-6 rounded-3xl border border-white/5 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="space-y-2">
                ...
                <input type="text" :value="getDisplayValue(formData.monto_total)" @input="e => updateCurrencyField(formData, 'monto_total', e)" required class="w-full bg-black/20 border border-white/10 rounded-2xl px-5 py-4 text-white font-bold focus:outline-none focus:border-primary/50" />
              </div>
