...
-- Tiempo de generación: 12-09-2026 a las 13:12:02
...
(1, 'banco industrial', '984651023', 'monetaria', 'GTQ', 1, 0.00, 872625.67, '2026-05-21 16:33:37', '2026-09-11 23:54:07'),
...
(5, 'CALERA BR', '12345', 'Monetaria', 'GTQ', 1, 0.00, 500000.00, '2026-09-12 03:30:46', '2026-09-12 10:34:42');
...
--
-- Volcado de datos para la tabla `concrete_trips`
--

INSERT INTO `concrete_trips` (`id`, `proyecto_id`, `vehiculo_id`, `piloto_id`, `m3_arena`, `m3_piedrin`, `m3_cemento`, `m3`, `hora_planta`, `lat_planta`, `lng_planta`, `hora_salida`, `hora_llegada`, `lat_piloto`, `lng_piloto`, `tipo_concreto`, `hora_llegada_obra`, `lat_colocacion`, `lng_colocacion`, `estado`, `created_by`, `created_at`) VALUES
(5, 3, 1, 8, 10.00, 10.00, 10.00, 10.00, '18:26:10', 15.09687622, -90.31474243, '15:00:00', '17:00:00', 15.09687744, -90.31475159, 'Bordillo', '17:30:00', 15.09687744, -90.31475159, 4, 2, '2026-09-12 00:26:10');
...
CREATE TABLE `contractors` (
  ...
  `encargado_nombre` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `contractors` (`id`, `empresa`, `representante`, `nombre`, `telefono`, `correo_electronico`, `created_at`, `updated_at`, `encargado_id`, `encargado_nombre`) VALUES
(1, 'INVERSIONES CYD', 'PACO PEREZ', 'INVERSIONES CYD', '9798-7978', 'prueba1contratista@gmail.com', '2026-07-24 14:25:37', '2026-09-08 17:36:38', NULL, 'JUAN LUIS, MARIO MARIO'),
(2, 'MULTISERVICIOS HMD', 'ELDER ELIAS', 'MULTISERVICIOS HMD', '5979-1255', NULL, '2026-09-11 22:59:44', '2026-09-11 22:59:44', NULL, 'DANIEL ELIAS, JULIO ELIAS, DIANA ELIAS');
...
INSERT INTO `employee_incidents` (`id`, `personnel_id`, `texto`, `fecha`, `motivo`, `adjunto_path`, `created_at`, `updated_at`) VALUES
(4, 11, 'AUSENCIA', '2026-09-02', 'NO SE PRESENTO', NULL, '2026-09-11 22:05:11', '2026-09-11 22:05:11');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `employee_payroll_payments`
--
...
--
-- Volcado de datos para la tabla `employee_payroll_payments`
--

INSERT INTO `employee_payroll_payments` (`id`, `personnel_id`, `periodo`, `fecha_pago`, `salario_base`, `dias_trabajados`, `sueldo_calculado`, `tiene_horas_extras`, `horas_extras`, `tarifa_hora_extra`, `monto_horas_extras`, `tiene_viaticos`, `monto_viaticos`, `observaciones_viaticos`, `total_pagar`, `metodo_pago`, `observaciones`, `created_at`, `cantidad_viaticos`, `fecha_viaticos_inicio`, `fecha_viaticos_fin`, `tiene_extra`, `monto_extra`, `observacion_extra`) VALUES
(1, 11, '2026-09', '2026-09-30', 5000.00, 30, 5000.00, 1, 7.00, 20.00, 140.00, 1, 500.00, '', 5640.00, 'Transferencia', NULL, '2026-09-11 21:57:30', 0, NULL, NULL, 0, 0.00, NULL),
(2, 10, '2026-09', '2026-09-30', 6500.00, 30, 6500.00, 0, 0.00, 0.00, 0.00, 0, 0.00, NULL, 6500.00, 'Transferencia', NULL, '2026-09-11 21:57:54', 0, NULL, NULL, 0, 0.00, NULL);
...
CREATE TABLE `expenses` (
  ...
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `dependiente` varchar(150) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `expenses` (`id`, `proyecto_id`, `contratista_id`, `tipo_egreso`, `monto`, `fecha_egreso`, `cuenta_origen`, `numero_cheque`, `beneficiario`, `descripcion`, `comprobante_path`, `created_at`, `dependiente`) VALUES
(4, NULL, NULL, 'Proveedor', 500.00, '2026-06-04', 'banco industrial - 984651023', '978415230.', 'Prueba 2', 'Prueba 2 para saber si ahora me descuenta el dinero con el banco que ya le di un ingreso', 'Uploads/Expenses/4/1780615046_carro3.jpg', '2026-06-04 23:17:26', NULL),
(5, NULL, NULL, 'Recurrentes', 300.00, '2026-06-05', 'banco industrial - 984651023', '894615320', 'Prueba', 'Prueba para saber si todo funciona correctamente al cargar todo y que funcione el egreso en el banco seleccionado', 'Uploads/Expenses/5/1780618026_carro4.jpg', '2026-06-05 00:07:06', NULL),
(6, NULL, NULL, 'Contratista', 20000.00, '2026-06-20', 'Banco gyt - 65410352130', '1', 'FELIPE', 'JFHSADHFADS', NULL, '2026-06-20 20:34:30', NULL),
(7, 6, 2, 'Contratista', 100000.00, '2026-09-11', 'banco industrial - 984651023', '1234', 'MULTISERVICIOS HMD', NULL, NULL, '2026-09-11 23:21:22', NULL),
(8, 2, 2, 'Contratista', 28574.33, '2026-09-11', 'banco industrial - 984651023', '5432', 'MULTISERVICIOS HMD', NULL, NULL, '2026-09-11 23:54:07', NULL);
...
(8, 7, 'ABONO DE VENTAS', 100000.00, '2026-09-11 23:21:22'),
(9, 8, 'AVANCE DE 10 METROS DE CARRETARA', 28574.33, '2026-09-11 23:54:07');
...
CREATE TABLE `fuel_records` (
  ...
  `proyecto_id` int(11) DEFAULT NULL,
  `proyectos_detalle` longtext DEFAULT NULL,
...
INSERT INTO `fuel_records` (`id`, `fecha`, `piloto_id`, `placa`, `tipo_unidad`, `proyecto_id`, `proyectos_detalle`, `cantidad_galones`, `precio_galon`, `monto`, `forma_pago`, `lugar`, `kilometraje`, `horometro`, `foto_1`, `foto_2`, `foto_3`, `created_at`, `updated_at`) VALUES
(1, '2026-06-20', 6, 'MD234M', 'Maquinaria', 2, NULL, 100.00, NULL, 200.00, NULL, NULL, NULL, 2000.00, 'Uploads/FuelRecords/1/foto_1.jpg', 'Uploads/FuelRecords/1/foto_2.jpg', NULL, '2026-06-20 00:20:45', '2026-06-20 00:22:02');
...
CREATE TABLE `heavy_transport` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `seguro_aseguradora` varchar(150) DEFAULT NULL,
  `seguro_contacto_nombre` varchar(150) DEFAULT NULL,
  `seguro_contacto_telefono` varchar(50) DEFAULT NULL,
  `seguro_poliza` varchar(100) DEFAULT NULL,
  `seguro_contrato_adjunto_path` varchar(255) DEFAULT NULL,
  `calcomania_adjunto_path` varchar(255) DEFAULT NULL,
  `titulo_propiedad_adjunto_path` varchar(255) DEFAULT NULL,
  `tarjeta_circulacion_adjunto_path` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `heavy_transport` (`id`, `placa`, `tipo_transporte`, `tipo_seguro`, `ubicacion`, `estado`, `precio`, `kilometraje`, `marca`, `modelo`, `piloto_id`, `foto_delantera`, `foto_trasera`, `foto_lateral1`, `foto_lateral2`, `created_at`, `updated_at`, `seguro_aseguradora`, `seguro_contacto_nombre`, `seguro_contacto_telefono`, `seguro_poliza`, `seguro_contrato_adjunto_path`, `calcomania_adjunto_path`, `titulo_propiedad_adjunto_path`, `tarjeta_circulacion_adjunto_path`) VALUES
(1, 'SDFIOUE98', 'Volteo', 'Danos a Terceros', 'Prueba de ubicacion', 'En Funcionamiento', 10000.00, 15000.00, 'Prueba', 'T680', 7, 'Uploads/HeavyTransport/1/foto_delantera.jpg', 'Uploads/HeavyTransport/1/foto_trasera.jpg', 'Uploads/HeavyTransport/1/foto_lateral1.jpg', 'Uploads/HeavyTransport/1/foto_lateral2.jpg', '2026-06-19 22:41:36', '2026-09-05 17:47:59', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'C0 727ccb', '', 'Full Cover', 'SANARATE', 'Inactivo', 290000.00, 155000.00, 'freighlitner', '2015', NULL, 'Uploads/HeavyTransport/2/foto_delantera.jpg', 'Uploads/HeavyTransport/2/foto_trasera.jpg', 'Uploads/HeavyTransport/2/foto_lateral1.jpg', 'Uploads/HeavyTransport/2/foto_lateral2.jpg', '2026-09-11 22:09:45', '2026-09-11 22:11:10', 'RURAL', 'JUAN', '45678923', '67898765', 'Uploads/HeavyTransport/2/docs/seguro_contrato_adjunto_1789164585.png', NULL, NULL, NULL);
...
(6, NULL, 'RENTA', 15000.00, '2026-06-20', 'Banco gyt - 65410352130', '4567890', 'MARIO CHEN', 'HORAS DE PATROL. DE PROYECTO.', NULL, '2026-06-20 20:25:30'),
(7, 6, 'HORAS EXTRAS', 500000.00, '2026-09-11', 'banco industrial - 984651023', '23456', 'VICTOR RODAS', 'CONCEPTO DE PAGO DE HORAS', 'Uploads/Incomes/7/1789168677_ee698189-1281-4665-a31f-aa424c9f0afc-nowater.jpg', '2026-09-11 23:17:57'),
(8, 6, 'COPERATIVA COIITZA', 500000.00, '2026-09-10', 'banco industrial - 984651023', '2345', 'COITZA', NULL, NULL, '2026-09-11 23:19:55'),
(9, 6, 'Estimacion', 500000.00, '2026-09-12', 'CALERA BR - 12345', '3212', 'Consejo de Desarrollo', 'Cobro de Estimación (1) - Fuente: Consejo de Desarrollo', NULL, '2026-09-12 10:34:42');
...
(9, 7, 'HORAS PATROL', 500000.00, '2026-09-11 23:17:57'),
(10, 8, 'CAMIONES', 250000.00, '2026-09-11 23:19:55'),
(11, 8, 'RETRO', 140000.00, '2026-09-11 23:19:55'),
(12, 8, 'RODOS', 110000.00, '2026-09-11 23:19:55');
...
(3, 'Material', '64564', 'Cemento', 'Cemento de buena calidad', 'Unidades', 100.00, 240.00, '2026-05-20 21:03:34', '2026-09-12 00:26:10'),
...
(7, 'Material', '984615', 'Arena', NULL, 'm3', 1.00, 50.00, '2026-06-17 20:47:09', '2026-09-12 00:26:10'),
(8, 'Material', '987461502', 'Piedrin', NULL, 'm3', 1.00, 60.00, '2026-06-17 20:48:23', '2026-09-12 00:26:10'),
(9, 'Material', '', 'Sillas de Metal', 'Sillas de Metal', 'Unidad', 5.00, 3.00, '2026-06-18 17:31:28', '2026-06-18 17:40:50'),
(10, 'Herramienta', '456', 'PALAS', 'PALAS DE CONSTRUCCION', 'UNIDAD', 5.00, -3.00, '2026-09-12 00:10:57', '2026-09-12 00:14:41');
...
(16, 'Entrada', 10, NULL, NULL, 20.00, 200.00, '4567H', NULL, '[\"Uploads\\/Inventory\\/16\\/foto_1_1789171981.jpg\"]', '2026-09-12 00:11:00', '2026-09-12 00:13:01'),
(17, 'Traslado', 10, NULL, 3, 23.00, 0.00, NULL, NULL, NULL, '2026-09-12 00:14:00', '2026-09-12 00:14:41');
...
CREATE TABLE `machinery` (
  ...
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `created_by` int(11) DEFAULT NULL,
  `clasificacion_tipo` varchar(50) DEFAULT 'Pesada',
  `no_factura` varchar(100) DEFAULT NULL,
  `fecha_servicio` date DEFAULT NULL,
  `seguro_contacto_nombre` varchar(255) DEFAULT NULL,
  `seguro_contacto_telefono` varchar(50) DEFAULT NULL,
  `seguro_aseguradora` varchar(255) DEFAULT NULL,
  `seguro_contrato_adjunto_path` varchar(255) DEFAULT NULL,
  `frecuencia_servicio_horas` int(11) DEFAULT 0,
...
INSERT INTO `machinery` (`id`, `categoria`, `codigo_interno`, `marca`, `modelo`, `numero_serie`, `anio_fabricacion`, `placa`, `horometro_actual`, `operador_id`, `proyecto_id`, `estado`, `costo_adquisicion`, `fecha_adquisicion`, `foto_path`, `fotos_json`, `created_at`, `created_by`, `clasificacion_tipo`, `no_factura`, `fecha_servicio`, `seguro_contacto_nombre`, `seguro_contacto_telefono`, `seguro_aseguradora`, `seguro_contrato_adjunto_path`, `frecuencia_servicio_horas`, `proveedor_compra`, `telefono_proveedor`) VALUES
(1, 'Maquinaria Especial', '001-2026', 'CAT', 'MOTONIVELADORA', '234DFSDF234', 2001, '567sfd', 1950, NULL, 1, 'Activo', 700000.00, '2026-05-22', 'Uploads/Machinery/1/foto.jpg', NULL, '2026-05-20 19:45:11', NULL, 'Pesada', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(2, 'Maquinaria Pesada', 'EX-042', 'CATERPILAR', '2026', 'SDFDF23423', 2002, 'MD234M', 1600, NULL, 2, 'Activo', 500.00, '2026-05-20', 'Uploads/Machinery/2/foto.jpg', NULL, '2026-05-22 22:31:16', NULL, 'Pesada', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(3, 'Transporte Pesado', 'EXC-8451', 'PJD', 'SDFC202', 'SDFSF', 2026, 'SDCSEEF', 1000, NULL, 3, 'Activo', 20000.00, '2026-06-21', 'Uploads/Machinery/3/foto.jpg', NULL, '2026-06-17 18:04:23', 2, 'Pesada', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(4, 'Vehículo', 'SDFC', 'Honda', 'Prueba', 'SDFPIOUSJEF', 2005, 'SDSDF8798', 5000, NULL, 2, 'Activo', 2000.00, '2026-06-20', 'Uploads/Machinery/4/foto.jpg', NULL, '2026-06-19 22:19:29', 2, 'Pesada', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(5, 'Generador Eléctrico', '567892', 'CATERPILLAR', '732', NULL, NULL, NULL, 20, 5, NULL, 'Activo', 20000.00, '2026-09-11', NULL, NULL, '2026-09-11 22:19:35', 2, 'Liviana', NULL, '2026-09-30', NULL, NULL, NULL, NULL, 0, NULL, NULL);
...
CREATE TABLE `machinery_log` (
  ...
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `created_by` int(11) DEFAULT NULL,
  `precio_renta` decimal(10,2) DEFAULT 0.00
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `machinery_log` (`id`, `maquina_id`, `proyecto_id`, `fecha`, `horometro_inicial`, `horometro_final`, `combustible_consumido`, `observaciones`, `operador_id`, `created_at`, `created_by`, `precio_renta`) VALUES
(1, 1, 1, '2026-05-20', 15000, 30000, 95641.00, 'Prueba para saber si todo funciona correctamente', NULL, '2026-05-20 19:46:39', NULL, 0.00),
(3, 2, 1, '2026-05-22', 600, 1500, 3600.00, 'Prueba para saber si todo carga bien', NULL, '2026-05-22 22:32:14', NULL, 0.00),
(4, 5, 3, '2026-09-11', 10, 20, 3.00, 'NFASDFA', 5, '2026-09-11 22:20:38', 2, 0.00);
...
CREATE TABLE `mechanic_records` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `mano_obra_proveedor_id` int(11) DEFAULT NULL,
  `mano_obra_proveedor_nombre` varchar(255) DEFAULT NULL,
  `mano_obra_monto` decimal(10,2) DEFAULT 0.00,
  `mano_obra_factura` varchar(255) DEFAULT NULL,
  `observaciones` text DEFAULT NULL,
  `proximo_servicio_km` decimal(10,2) DEFAULT NULL,
  `proximo_servicio_hrs` decimal(10,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `mechanic_records` (`id`, `fecha`, `placa`, `tipo_unidad`, `tipo_trabajo`, `proveedor_id`, `foto_1`, `foto_2`, `foto_3`, `foto_4`, `foto_5`, `created_at`, `updated_at`, `mano_obra_proveedor_id`, `mano_obra_proveedor_nombre`, `mano_obra_monto`, `mano_obra_factura`, `observaciones`, `proximo_servicio_km`, `proximo_servicio_hrs`) VALUES
(1, '2026-06-20', '567sfd', 'Maquinaria', NULL, 3, 'Uploads/MechanicRecords/1/foto_1.jpg', 'Uploads/MechanicRecords/1/foto_2.jpg', 'Uploads/MechanicRecords/1/foto_3.jpg', 'Uploads/MechanicRecords/1/foto_4.jpg', 'Uploads/MechanicRecords/1/foto_5.jpg', '2026-06-20 00:36:35', '2026-06-20 00:36:35', NULL, NULL, 0.00, NULL, NULL, NULL, NULL),
(2, '2026-09-11', 'MD234M', 'Maquinaria', 'CAMBIO DE LLANTAS', NULL, NULL, NULL, NULL, NULL, NULL, '2026-09-11 22:55:22', '2026-09-11 22:55:22', 4, NULL, 1500.00, '', '', NULL, NULL);
...
INSERT INTO `mechanic_record_items` (`id`, `mechanic_record_id`, `producto`, `monto`, `proveedor_id`, `foto_factura`, `detalles_json`) VALUES
(3, 1, 'Producto 1', 100.00, NULL, NULL, NULL),
(4, 1, 'Prodcuto 2', 20.00, NULL, NULL, NULL),
(5, 2, 'LLANTA DELANTERAS', 1500.00, 4, NULL, NULL),
(6, 2, 'CAMBIO DE ACEITE', 7372.00, 4, NULL, '[{\"producto\":\"FILTRO DE ACEITE\",\"monto\":6372},{\"producto\":\"ACEITE\",\"monto\":1000}]');
...
CREATE TABLE `personnel` (
  ...
  `depto_nacimiento` varchar(100) DEFAULT NULL,
  `muni_nacimiento` varchar(100) DEFAULT NULL,
  ...
  `foto_path` varchar(255) DEFAULT NULL,
  `dpi_adjunto_path` varchar(255) DEFAULT NULL,
  `contrato_adjunto_path` varchar(255) DEFAULT NULL,
  `licencia_adjunto_path` varchar(255) DEFAULT NULL,
  `proyecto_id` int(11) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `personnel` (`id`, `tipo_empleado`, `nombres`, `apellidos`, `dpi`, `nit`, `telefono`, `direccion`, `puesto`, `tipo_planilla`, `salario_base`, `bonificacion`, `tarifa_hora_extra`, `diario_viaticos`, `contacto_nombres`, `contacto_numero`, `cantidad_hijos`, `edades_hijos`, `nivel_academico`, `titulo_academico`, `fecha_nacimiento`, `depto_nacimiento`, `muni_nacimiento`, `estado_civil`, `igss`, `igss_numero`, `fecha_contratacion`, `fecha_baja`, `numero_cuenta`, `nombre_cuenta`, `nombre_banco`, `foto_path`, `dpi_adjunto_path`, `contrato_adjunto_path`, `licencia_adjunto_path`, `proyecto_id`, `created_at`, `updated_at`) VALUES
(5, 'Administrativo', 'MARIA LUISA', 'CASTAÑEDA RAMIREZ', '2574591540101', NULL, '2574-5915', NULL, 'ENLACE INSTITUCIONAL', 'Mensual', 4500.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1984-03-03', NULL, NULL, NULL, NULL, NULL, '2025-01-01', NULL, '3180022507', NULL, 'BANRURAL', 'Uploads/Personal/5/foto.jpg', NULL, NULL, NULL, NULL, '2026-06-18 22:18:33', '2026-06-20 15:21:47'),
(6, 'Administrativo', 'JOSSELINE MARIELY', 'GARCIA ALVARADO', '3054010250207', NULL, '5987-5845', 'SANARATE', 'GERENCIA DE OPERACIONES', 'Mensual', 5000.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-11-18', NULL, '4489030602', NULL, 'BANRURAL', NULL, NULL, NULL, NULL, NULL, '2026-06-18 22:23:30', '2026-06-18 22:23:30'),
(7, 'Administrativo', 'CESAR DAVID', 'RODAS MORAN', '3054346240207', NULL, '4216-6118', 'SANARATE', 'LOGISTICA', 'Mensual', 3000.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-06-01', NULL, '905431888', NULL, 'BAC', NULL, NULL, NULL, NULL, NULL, '2026-06-18 22:25:50', '2026-06-18 22:26:14'),
(8, 'Operador', 'ALEJANDRO ENRIQUE', 'DEL CID CALDERON', '2224084050207', NULL, '4030-7215', 'SANARATE, COLONIA GRACIAS A DIOS', 'OPERADOR DE MAQUINARIA', 'Semanal', 1750.00, NULL, 36.46, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-06-01', NULL, '3180064315', NULL, 'BANRURAL', NULL, NULL, NULL, NULL, NULL, '2026-06-18 22:30:53', '2026-06-18 22:30:53'),
(9, 'Contratista', 'Prueba', 'Empleado', '7894615320231', '9846512', '8946-1532', 'Prueba para ver si todo carga correctamente', 'Prueba', 'Mensual', 5000.00, NULL, 10.00, 20.00, 'Prueba Contacto', '9874-6513', 2, NULL, 'Primaria', NULL, '2004-07-16', NULL, NULL, NULL, 1, '9846510', '2026-06-07', NULL, 'Prueba de Cuenta', NULL, 'Prueba de Banco', NULL, NULL, NULL, NULL, NULL, '2026-06-19 15:51:00', '2026-09-03 13:17:27'),
(10, 'Administrativo', 'SABRINA MISHELL', 'GÁLVEZ LÓPEZ', '2990569960101', '102117500', '3035-7162', 'LAS LOMAS, SALAMÁ', 'GERENTE FINANCIERA', 'Mensual', 6500.00, NULL, NULL, NULL, 'YADIRA LOPEZ', '3112-2748', NULL, NULL, 'Universidad', NULL, '1999-09-28', 'GUATEMALA', 'GUATEMALA', 'Soltero(a)', 0, NULL, '2023-12-05', NULL, '3151041696', NULL, 'BANRURAL', 'Uploads/Personal/10/foto.png', 'Uploads/Personal/10/dpi.png', 'Uploads/Personal/10/contrato.pdf', 'Uploads/Personal/10/licencia.png', NULL, '2026-09-11 21:40:44', '2026-09-11 21:40:44'),
(11, 'Piloto', 'VICTOR GERARDO', 'RODAS CARDONA', '1693137000101', '14975807', '5555-0007', 'EL PROGRESO,SANARATE', 'PILOTO DE MIXER', 'Mensual', 5000.00, NULL, 20.00, 30.00, 'PEDRO', '3292-7237', 3, '[\"\",\"\",\"\"]', 'Universidad', NULL, '1980-07-27', 'GUATEMALA', 'GUATEMALA', 'Casado(a)', 0, NULL, '2020-01-01', NULL, '903015675', NULL, 'BAC', NULL, NULL, NULL, NULL, NULL, '2026-09-11 21:52:14', '2026-09-11 21:52:14');
...
CREATE TABLE `projects` (
  ...
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `snip` varchar(100) DEFAULT NULL,
  `nog` varchar(100) DEFAULT NULL,
  `monto_cocode` decimal(14,2) DEFAULT 0.00,
  `monto_muni` decimal(14,2) DEFAULT 0.00,
  `monto_comunidad` decimal(14,2) DEFAULT 0.00,
  `tipo_inversion` varchar(100) DEFAULT NULL,
  `foto_contrato` varchar(255) DEFAULT NULL,
  `excel_presupuesto` varchar(255) DEFAULT NULL,
  `especificaciones_tecnicas` varchar(255) DEFAULT NULL,
  `convenios_archivos` text DEFAULT NULL
...
INSERT INTO `projects` (`id`, `codigo`, `nombre`, `cliente_id`, `ubicacion`, `coordenadas`, `presupuesto`, `fecha_inicio`, `fecha_fin_estimada`, `fecha_fin_real`, `estado`, `numero_contrato`, `contratos_archivos`, `foto`, `descripcion`, `contactos`, `gerente_id`, `created_at`, `updated_at`, `snip`, `nog`, `monto_cocode`, `monto_muni`, `monto_comunidad`, `tipo_inversion`, `foto_contrato`, `excel_presupuesto`, `especificaciones_tecnicas`, `convenios_archivos`) VALUES
(1, '2026-001', 'Puente', 1, 'Zona 14', '14.600518, -90.509191', 20000.00, '2026-05-01', '2026-05-14', '2026-05-20', 'Activo', '0000', '[\"Uploads\\/Projects\\/1\\/docs\\/FODA_de_trabajo_de_graduaci__n.pdf\",\"Uploads\\/Projects\\/1\\/docs\\/Propuesta_te__rica_y_dise__o_de_la_propuesta_te__rica.pdf\",\"Uploads\\/Projects\\/1\\/docs\\/Evaluaci__n_Final_____Pregunta_1.pdf\"]', 'Uploads/Projects/1/foto_1779738193.webp', 'Prueba para saber si todo funciona correctamente y sin problema', '[{\"tipo\":\"Proveedor\",\"nombre\":\"Prueba 1\",\"telefono\":\"98754132\",\"email\":\"prueba1@gmail.com\"}]', 2, '2026-05-20 18:18:29', '2026-05-26 14:44:05', NULL, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL),
(2, 'PRY-001-2026', 'ASFALTO', 1, 'Zona 16', '14.628476, -90.510521', 250000.00, '2026-05-01', '2026-05-10', '2026-05-23', 'Activo', '894156', '[\"Uploads\\/Projects\\/2\\/docs\\/PROYECTO_FINAL.pdf\",\"Uploads\\/Projects\\/2\\/docs\\/Evaluaci__n_Final_____Pregunta_4.pdf\"]', 'Uploads/Projects/2/foto_1779738092.png', 'Prueba 2 para saber si funciona todo correctamente', '[{\"tipo\":\"Supervisor\",\"nombre\":\"Rodrigo\",\"telefono\":\"8798-9874\",\"email\":\"prueba@gmail.com\"}]', 2, '2026-05-22 22:40:16', '2026-06-18 13:54:47', NULL, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL),
(3, '26-001', 'CENTRO DE SALUD, SALAMÁ', 2, 'BARRIO AGUA CALIENTE, BAJA VERAPAZ', '15.102513, -90.327197', 5023500.00, '2024-08-19', '2026-05-25', '2026-05-25', 'Completado', '', NULL, 'Uploads/Projects/3/foto_1781806507.JPG', 'Construcción de edificio continuo a edificio central del centro de Salud. ', '[]', 2, '2026-06-18 18:15:07', '2026-06-18 18:15:07', NULL, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL),
(6, '23456', 'MEJORAMIENTO PARQUE  CENTRAL CONACASTE', 2, 'CONACASTE', '14.974761, -90.401001', 1000000.00, '2026-09-01', '2026-12-30', NULL, 'Activo', '1234567', NULL, 'Uploads/Projects/6/foto_1789168029_6aa4899dec6b2.jpg', 'MEJORAMIENTO DE PARQUE', '[{\"tipo\":\"Supervisor\",\"nombre\":\"DONALDO TAX\",\"telefono\":\"555555555\",\"email\":\"\"}]', 3, '2026-09-11 23:07:09', '2026-09-11 23:07:09', '123456', '102030', 950000.00, 45000.00, 5000.00, 'Ordinario', NULL, NULL, NULL, NULL);
...
--
-- Volcado de datos para la tabla `project_contractors`
--

INSERT INTO `project_contractors` (`id`, `project_id`, `contractor_id`, `monto_contratado`, `fecha_asignacion`, `observaciones`, `created_at`, `updated_at`) VALUES
(2, 6, 2, 100000.00, '2026-09-11', 'VENTANAS', '2026-09-11 23:23:32', '2026-09-11 23:23:32'),
(3, 2, 2, 200000.00, '2026-09-11', 'REALIZACION DE 100 METROS DE CARRETERA', '2026-09-11 23:53:08', '2026-09-11 23:53:08');
...
(14, 6, 'Anticipo', NULL, 200000.00, 20.00, '2026-09-11', NULL, '2026-09-11 23:09:12', '2026-09-11 23:09:12'),
(15, 6, 'Estimacion', 1, 500000.00, 50.00, '2026-09-12', NULL, '2026-09-12 10:34:42', '2026-09-12 10:34:42');
...
(40, 14, 'Consejo de Desarrollo', 100.00, 200000.00, '2026-09-11', NULL, 1, NULL, 'Recibido', '2026-09-11 23:09:12', '2026-09-11 23:09:12'),
(41, 14, 'Municipalidad', 0.00, 0.00, NULL, NULL, NULL, NULL, 'Pendiente', '2026-09-11 23:09:12', '2026-09-11 23:09:12'),
(42, 14, 'COCODE', 0.00, 0.00, NULL, NULL, NULL, NULL, 'Pendiente', '2026-09-11 23:09:12', '2026-09-11 23:09:12'),
(43, 15, 'Consejo de Desarrollo', 100.00, 500000.00, '2026-09-12', '3212', 5, NULL, 'Recibido', '2026-09-12 10:34:42', '2026-09-12 10:34:42'),
(44, 15, 'Municipalidad', 0.00, 0.00, NULL, NULL, NULL, NULL, 'Pendiente', '2026-09-12 10:34:42', '2026-09-12 10:34:42'),
(45, 15, 'COCODE', 0.00, 0.00, NULL, NULL, NULL, NULL, 'Pendiente', '2026-09-12 10:34:42', '2026-09-12 10:34:42');
...
INSERT INTO `recurrents` (`id`, `concepto`, `descripcion`, `monto`, `dia_pago`, `created_by`, `created_at`, `updated_at`, `beneficiario`, `cuenta`) VALUES
(4, 'Pago de luz', 'prueba para saber si todo carga correctamente', 200.00, 16, 2, '2026-06-17 18:01:08', '2026-06-17 18:01:08', NULL, NULL),
(5, 'Pago de agua', 'prueba', 100.00, 17, 2, '2026-06-18 18:24:11', '2026-06-18 18:24:11', NULL, NULL),
(6, 'pago de agua', 'prueba tecnico', 200.00, 18, 3, '2026-06-18 20:47:43', '2026-06-18 20:47:43', NULL, NULL),
(7, 'PAGO DE RENTA', 'CASA PILOTOS', 1000.00, 12, 2, '2026-09-12 00:05:39', '2026-09-12 00:05:39', NULL, NULL);
...
INSERT INTO `special_machinery` (`id`, `codigo`, `nombre`, `tipo_maquinaria`, `subtipo`, `marca`, `modelo`, `anio`, `estado`, `valor`, `ubicacion`, `responsable_id`, `foto_1`, `foto_2`, `foto_3`, `foto_4`, `foto_5`, `created_at`, `updated_at`, `seguro_aseguradora`, `seguro_contacto_nombre`, `seguro_contacto_telefono`, `seguro_poliza`, `seguro_contrato_adjunto_path`) VALUES
(1, NULL, 'Prueba', 'Elevacion', 'Montacarga', 'Prueba de Marca', 'Prueba de Modelo', 2026, 'En Funcionamiento', NULL, 'Prueba de Ubicacion para ver si funciona todo correctamente', 8, 'Uploads/SpecialMachinery/1/foto_1.jpg', 'Uploads/SpecialMachinery/1/foto_2.jpg', 'Uploads/SpecialMachinery/1/foto_3.jpg', 'Uploads/SpecialMachinery/1/foto_4.jpg', 'Uploads/SpecialMachinery/1/foto_5.jpg', '2026-06-20 00:02:08', '2026-06-20 00:03:54', NULL, NULL, NULL, NULL, NULL);
...
(4, 'Jary Orellana', '2345678', 'Sanarate', '4567-8902', NULL, 'Jary', 'Contado', NULL, '2026-09-05 16:46:50', '2026-09-05 16:46:50');
...
(6, 'Destajo', '2026-09-11 21:31:43'),
(7, 'Albañil', '2026-09-11 21:32:44');
...
INSERT INTO `vehicles` (`id`, `placa`, `tipo_vehiculo`, `tipo_seguro`, `ubicacion`, `precio`, `kilometraje`, `marca`, `modelo`, `piloto_id`, `foto_delantera`, `foto_trasera`, `foto_lateral1`, `foto_lateral2`, `estatus`, `created_at`, `updated_at`, `seguro_contacto_nombre`, `seguro_contacto_telefono`, `seguro_aseguradora`, `seguro_contrato_adjunto_path`, `calcomania_adjunto_path`, `titulo_propiedad_adjunto_path`, `tarjeta_circulacion_adjunto_path`) VALUES
(3, 'Prueba ', 'Pickup', NULL, 'Prueba de ubicacion', 20000.00, 15000.00, 'Honda', '2024', 9, 'Uploads/Vehicles/3/foto_delantera.jpg', 'Uploads/Vehicles/3/foto_trasera.jpg', 'Uploads/Vehicles/3/foto_lateral1.jpg', 'Uploads/Vehicles/3/foto_lateral2.jpg', 'En Funcionamiento', '2026-06-19 22:04:28', '2026-09-05 17:47:25', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `vehicle_logs` (
  ...
  `proyecto_id` int(11) DEFAULT NULL,
  `kilometraje_inicial` decimal(10,2) DEFAULT 0.00,
...
INSERT INTO `vehicle_logs` (`id`, `vehiculo_id`, `piloto_id`, `estatus_vehiculo`, `envio_servicio`, `reportar_averia`, `observaciones`, `fecha_registro`, `fecha`, `proyecto_id`, `kilometraje_inicial`, `kilometraje_final`, `combustible_consumido`, `precio_renta`, `created_by`) VALUES
(3, 3, 9, 'Inactivo', 'Prueba para saber si cambia de estado al momento de cambiarle el estado en la bitacora', 'Prueba para saber si funciona todo correctamente', 'Prueba para saber si todo carga correctamente en la base de datos', '2026-06-19 22:06:59', NULL, NULL, 0.00, 0.00, 0.00, 0.00, NULL);
...
CREATE TABLE `viaticos` (
  ...
  `dias_detalle` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`dias_detalle`)),
...
INSERT INTO `viaticos` (`id`, `personnel_id`, `periodo`, `dias_detalle`, `total_tiempos`, `valor_viatico`, `fecha_solicitud`, `fecha_inicio`, `fecha_fin`, `monto`, `motivo`, `estado`, `observaciones`, `created_at`) VALUES
(1, 11, '2026-09', '{\"2026-09-03\":3,\"2026-09-10\":2,\"2026-09-11\":3}', 8, 30.00, '2026-09-12', NULL, NULL, 240.00, 'Viáticos del Mes', 'Aprobado', 'Extras', '2026-09-12 10:46:19');
...
ALTER TABLE `concrete_trips`
  ...
  ADD KEY `concrete_trips_ibfk_2` (`vehiculo_id`);
...
--
-- Indices de la tabla `employee_payroll_payments`
--
ALTER TABLE `employee_payroll_payments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pay_personnel` (`personnel_id`);
...
ALTER TABLE `viaticos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_viatico_personnel` (`personnel_id`);
...
--
-- AUTO_INCREMENT de la tabla `employee_payroll_payments`
--
ALTER TABLE `employee_payroll_payments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
