...
const pageTitle = computed(() => {
    switch (currentView.value) {
        ...
        case 'magaaudit': return 'Bitácora de Auditoría';
        case 'visardashboard': return 'Panel Ejecutivo';
        case 'visarexportaciones': return 'VISAR · Control de Exportaciones';
        case 'visarimportaciones': return 'VISAR · Control de Importaciones';
        case 'visarlicenciastransporte': return 'VISAR · Control de Licencias Transporte';
        case 'visarlicenciasfitosanitarias': return 'VISAR · Control de Licencias Fito';
        case 'visarlibreventa': return 'VISAR · Control de Libre Venta';
        default: return 'Sistema VISAR';
    }
});
