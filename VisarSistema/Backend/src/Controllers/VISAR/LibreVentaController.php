...
use App\Services\VISAR\VisarLibreVentaService;
use Exception;

#[HasPrivilege('modulo_visar')]
class LibreVentaController extends Controller
{
    private $service;

    public function __construct()
    {
        $this->service = new VisarLibreVentaService();
    }

    #[Route('/visar/libre-venta', 'GET')]
    public function index()
    {
        try {
            ...
            $data = $this->service->getRegistros($filters, $page, $perPage);
    ...
    #[Route('/visar/libre-venta/stats', 'GET')]
    ...
    #[Route('/visar/libre-venta/importar', 'POST')]
    public function importar()
    {
        try {
            ...
            (new \App\Services\Notifications\NotificationService())->createGlobalNotification(
                "Importación Exitosa", 
                "Se importaron {$result['nuevos']} registros de Libre Venta en VISAR.", 
                "success"
            );
