<template>
    <div class="max-w-4xl mx-auto p-8 bg-white text-black font-serif leading-relaxed">
        ...
        <div v-else-if="!noConformidad" class="py-20 text-center no-print">
            <p class="text-red-500 font-bold">Error al cargar los datos de la no conformidad.</p>
        </div>
            ...
            <div class="border-b-4 border-slate-900 pb-4 flex justify-between items-center">
                <div class="flex items-center gap-3">
                    <div class="w-12 h-12 flex items-center justify-center bg-slate-100 rounded border border-slate-300">
                        <span class="material-symbols-outlined text-3xl text-slate-800">assignment_late</span>
                    </div>
                    <div>
...
const fetchDetalle = async () => {
    ...
    try {
        ...
        console.error('Error al cargar reporte de no conformidad', error);
    } finally {
        loading.value = false;
    }
};
