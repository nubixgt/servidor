<template>
    <div class="max-w-5xl mx-auto">
        ...
        <div v-else-if="!supervision" class="py-20 text-center bg-white border border-surface-container rounded-2xl">
            ...
            <router-link to="/supervisiones" class="mt-6 inline-flex items-center gap-2 text-xs font-bold text-primary hover:underline">
        ...
        <div v-else class="space-y-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 pb-6">
                <div>
                    ...
                    <h1 class="text-3xl font-black tracking-tight text-on-surface mt-2">{{ supervision.establecimiento }}</h1>
                    <p class="text-xs text-on-surface-variant mt-1">Registrado el {{ formatDateFull(supervision.fecha_creacion) }}</p>
                </div>
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-surface-container-lowest p-6 rounded-2xl border border-surface-container shadow-ambient">
                        ...
                        <div class="flex items-center gap-4 text-xs">
                            ...
                            <div>
                                <p class="font-bold text-on-surface text-sm">{{ supervision.inspector_nombre }}</p>
                                <p class="text-[10px] text-on-surface-variant font-mono mt-0.5">Código: {{ supervision.inspector_codigo }} | Área: {{ supervision.inspector_area }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    >
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                <label class="block text-[10px] font-bold text-on-surface-variant uppercase tracking-wider mb-2">Verificación del Oficial</label>
                                <textarea 
