<template>
    <div class="max-w-5xl mx-auto">
        ...
        <div v-else-if="!supervision" class="py-20 text-center bg-white border border-slate-200 rounded-md shadow-sm">
            <span class="material-symbols-outlined text-5xl text-red-500">warning</span>
            <p class="text-sm font-semibold text-slate-800 mt-4">No se pudo cargar la supervisión</p>
            <p class="text-xs text-slate-400 mt-1">El registro solicitado no existe o no tiene permisos de acceso.</p>
            <router-link to="/supervisiones" class="mt-6 inline-flex items-center gap-2 text-xs font-bold text-slate-800 hover:underline">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white/95 backdrop-blur-sm p-6 rounded-2xl border border-white/20 shadow-premium">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                            <div class="p-3 bg-slate-50 rounded border border-slate-200">
                                ...
                                <span class="font-bold text-slate-800 text-sm">{{ supervision.establecimiento }}</span>
                            </div>
                            <div class="p-3 bg-slate-50 rounded border border-slate-200">
                                <span class="text-[9px] font-bold text-slate-400 uppercase tracking-wider block">Fecha de Supervisión</span>
                                <span class="font-mono font-bold text-slate-800 text-sm">{{ supervision.fecha_supervision }}</span>
                            </div>
                            <div class="p-3 bg-slate-50 rounded border border-slate-200">
                                <span class="text-[9px] font-bold text-slate-400 uppercase tracking-wider block">Norma Específica Asociada</span>
                                <span class="font-bold text-slate-800 text-sm">{{ supervision.norma_especifica || 'Ninguna registrada' }}</span>
                            </div>
                    ...
                    <div class="bg-white/95 backdrop-blur-sm p-6 rounded-2xl border border-white/20 shadow-premium">
                        ...
                        <div class="flex items-center gap-4 text-xs">
                            ...
                            <div>
                                <p class="font-bold text-slate-800 text-sm">{{ supervision.inspector_nombre }}</p>
