    ...
    <div>
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-2xl border border-white/20 shadow-premium overflow-hidden">
            ...
            <div v-else-if="filteredSupervisiones.length === 0" class="py-20 text-center">
                ...
                <p class="text-sm font-semibold text-slate-800 mt-4">No se encontraron supervisiones registradas</p>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-200 text-xs">
                        <tr v-for="s in filteredSupervisiones" :key="s.id" class="hover:bg-slate-50 transition-colors">
                            <!-- Establishment -->
                            <td class="px-6 py-4">
                                <p class="font-bold text-slate-800 text-sm">{{ s.establecimiento }}</p>
                                <p class="text-[9px] text-slate-400 font-mono">ID: {{ s.id }}</p>
                            </td>

                            <!-- Inspector -->
                            <td class="px-6 py-4">
                                <p class="font-bold text-slate-800">{{ s.inspector_nombre }}</p>
