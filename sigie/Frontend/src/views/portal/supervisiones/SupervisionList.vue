            ...
            <div v-else class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100 text-xs">
                        <tr v-for="s in filteredSupervisiones" :key="s.id" class="hover:bg-slate-50/50 transition-colors">
                            <!-- Establishment -->
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-on-surface-variant">
                                <span v-if="s.norma_especifica" class="font-semibold text-slate-700 bg-slate-100 px-2 py-1 rounded">
                                    {{ s.norma_especifica }}
                                </span>
