            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-surface-container-lowest p-6 rounded-2xl border border-surface-container shadow-ambient">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-bold text-on-surface-variant uppercase tracking-wider mb-2">Fecha de Supervisión *</label>
                            <input 
                        ...
                        <div>
                            <label class="block text-xs font-bold text-on-surface-variant uppercase tracking-wider mb-2">Inspector Responsable</label>
                            <input 
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-xs font-bold text-on-surface-variant uppercase tracking-wider mb-2">Establecimiento Supervisado *</label>
                            <input 
                ...
                <div class="bg-surface-container-lowest p-6 rounded-2xl border border-surface-container shadow-ambient">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-xs font-bold text-on-surface-variant uppercase tracking-wider mb-2">Hallazgos Detectados *</label>
                            <textarea 
