      ...
      <div class="max-w-[1440px] mx-auto px-6 md:px-16 flex flex-col md:flex-row justify-between items-start gap-12">
        ...
        <div class="grid grid-cols-2 gap-16">
          <div class="flex flex-col gap-2.5">
            <span class="text-[10px] font-bold tracking-widest text-gray-400 mb-2 uppercase">Páginas</span>
            <button @click="navigateTo('ModelDirectory')" class="text-xs text-black font-semibold text-left hover:opacity-75 cursor-pointer">Directorio</button>
            <button @click="navigateTo('LiveJudging')" class="text-xs text-black font-semibold text-left hover:opacity-75 cursor-pointer">Show en Vivo</button>
            <button @click="() => alert('Las descargas del kit de prensa se abrirán en breve.')" class="text-xs text-black font-semibold text-left hover:opacity-75 cursor-pointer">Kit de Prensa</button>
          </div>

          <div class="flex flex-col gap-2.5">
            <span class="text-[10px] font-bold tracking-widest text-gray-400 mb-2 uppercase">Sistema</span>
            <button @click="() => alert('Lineamientos legales para jurados.')" class="text-xs text-black font-semibold text-left hover:opacity-75 cursor-pointer">Legal</button>
            <button @click="() => alert('Declaración de privacidad.')" class="text-xs text-black font-semibold text-left hover:opacity-75 cursor-pointer">Privacidad</button>
            <button @click="() => alert('APIs del sistema de evaluación.')" class="text-xs text-black font-semibold text-left hover:opacity-75 cursor-pointer">API</button>
          </div>
        </div>
      </div>
