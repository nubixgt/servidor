/**
 * assets/js/pages/nueva-supervision-tecnico.js
 * Nueva Supervisión para Técnicos - JavaScript con SweetAlert2
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 Módulo de Nueva Supervisión (Técnico) cargado');
    ...
    .then(data => {
        ...
        if (data.success) {
            Swal.fire({
                ...
                // ⭐ RUTA CORREGIDA PARA TÉCNICOS
                window.location.href = `${BASE_URL}/modules/tecnico/supervisiones.php`;
            });
        } else {
            Swal.fire({
                title: '¡Error!',
