<?php
/**
 * modules/tecnico/nueva-supervision.php
 * Nueva Supervisión para Técnicos
...
$extraCSS = [
    ...
    SITE_URL . '/assets/css/pages/nueva-supervision.css'
];
...
$extraJS = [
    ...
    SITE_URL . '/assets/js/pages/nueva-supervision-tecnico.js'
];
                    ...
                    <div class="card-body">
                        <form id="formSupervision">
                            ...
                            <div class="form-actions">
                                <a href="<?php echo SITE_URL; ?>/modules/tecnico/supervisiones.php" class="btn btn-secondary">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
