...
// Municipios por departamento (división administrativa de Guatemala).
export const MUNICIPIOS_POR_DEPARTAMENTO = {
    ...
    'Alta Verapaz': [
        ...
        'Panzós', 'Senahú', 'San Pedro Carchá', 'San Juan Chamelco', 'Lanquín',
    ...
    'Zacapa': [
        ...
        'San Diego', 'La Unión', 'Huité', 'San Jorge',
    ],
    'Chiquimula': [
