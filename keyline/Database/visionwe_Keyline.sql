...
CREATE TABLE `parcelas` (
  ...
  `clase_textural` varchar(150) DEFAULT NULL COMMENT 'Clase textural del suelo (USDA) o valor libre',
  `pendiente` decimal(6,2) DEFAULT NULL COMMENT 'Pendiente estimada en %',
  `fuente_agua_principal` varchar(150) DEFAULT NULL COMMENT 'Fuente original de agua (principal)',
  `fuente_agua_secundaria` text DEFAULT NULL COMMENT 'Fuentes secundarias de agua, separadas por coma',
  ...
  `limitantes_uso` text DEFAULT NULL COMMENT 'Limitantes de uso de la parcela, separadas por coma',
  `bioindicadores` text DEFAULT NULL COMMENT 'Bioindicadores del suelo, separados por coma',
